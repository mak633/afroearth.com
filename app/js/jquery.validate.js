...
$.extend($.validator, {
	...
	messages: {
		...
		website: "Wrong web site.",
		websitehttp: "Wrong web site.",
		cod_fisc: "",
		p_iva: "",
	...
	classRuleSettings: {
		...
		websitehttp: {websitehttp: true},
		cod_fisc: {cod_fisc: true},
		p_iva: {p_iva: true},
		url: {url: true},
		date: {date: true},
	...
	methods: {
        ...
        ora: function(value, element) {            
            return this.optional(element) || /^(([0-1]?[0-9])|([2][0-3])):([0-5]?[0-9])(:([0-5]?[0-9]))?$/.test(value) || /^([\__]+)([\:]+)([\__]+)$/.test(value);                                                    
        },
        website: function(value, element) {            
            return this.optional(element) || /^((http|https):\/\/(www\.)?|www\.)[a-zA-Z0-9\_\-]+\.([a-zA-Z]{2,4}|[a-zA-Z]{2}\.[a-zA-Z]{2})(\/[a-zA-Z0-9\-\._\?\&=,'\+%\$#~]*)*$/.test(value);                                                    
        },
        websitehttp: function(value, element) {            
            return this.optional(element) || /^(http|ftp|https):\/\/[\w\-_]+(\.[\w\-_]+)+([\w\-\.,@?^=%&amp;:/~\+#]*[\w\-\@?^=%&amp;/~\+#])?$/.test(value);                                                    
        },                  	        	
        cod_fisc: function(value, element) {            
        ...
        no_space: function(value, element) {            
